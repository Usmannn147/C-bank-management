...
{
	cout<<accno<<setw(10)<<" "<<name<<setw(10)<<" "<<type<<setw(6)<<Money_Deposit<<endl;
}
...
int main()
{
	...
	cout<<"\n\t\t!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
		...
		cout<<"\t\t    ::MAIN SCREEN::\n";
		cout<<"\n\t\t1. NEW Bank_Account";
		cout<<"\n\t\t2. CASH_Deposit Total-Money";
		cout<<"\n\t\t3. WITHDRAW Total-Money";
		cout<<"\n\t\t4. BALANCE ENQUIRY";
		cout<<"\n\t\t5. ALL Bank_Account HOLDER LIST";
		cout<<"\n\t\t6. CLOSE A Bank_Account";
		cout<<"\n\t\t7. Update A Bank_Account";
		cout<<"\n\t\t8. EXIT";
